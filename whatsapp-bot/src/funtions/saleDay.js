...
const datasaletoday = require('../modules/dataventa/dataDay/dataDia'); // Obtener las compras
const sendWithInterval = require('../modules/dataventa/dataDay/intervarsed'); // Módulo para enviar con intervalo
